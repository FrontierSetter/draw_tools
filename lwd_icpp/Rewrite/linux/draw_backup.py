...
fileArr = [
    "../../new method/版本/linux t 100",
    "../../new method/版本/linux t 300",
    "../../new method/版本/linux t 500",
    "../../new method/版本/linux t 700",
    "../../new method/版本/linux t 900"
]
...
for i in range(len(dataArr)):
    ...
    plt.plot(dataArr[i][0],dataArr[i][1],label=curMethod,color=colorDict[curMethod], \
        marker=markerDict[curMethod],markersize=16,markevery=8,linewidth=line_width)
...
plt.savefig('../image/linux_backup.pdf')
