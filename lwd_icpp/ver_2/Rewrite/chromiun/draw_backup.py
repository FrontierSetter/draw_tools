...
fileArr = [
    "../../new method/版本/chromiun t 100",
    "../../new method/版本/chromiun t 300",
    "../../new method/版本/chromiun t 500",
    "../../new method/版本/chromiun t 700",
    "../../new method/版本/chromiun t 900"
]
...
for i in range(len(dataArr)):
    ...
    plt.plot(dataArr[i][0],dataArr[i][1],label=curMethod,color=colorDict[curMethod], \
        marker=markerDict[curMethod],markersize=16,markevery=getMarkerArr(len(dataArr[i][0]), 15), \
...
plt.savefig('../image/chromiun_backup.pdf')
