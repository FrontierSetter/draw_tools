...
#设置线宽
plt.plot(capping_improve_speed_factor,capping_improve_precent,label='capping',linewidth=2)
plt.plot(smr_improve_speed_factor,smr_improve_precent,label='smr',linewidth=2)
plt.plot(fcapping_improve_speed_factor,fcapping_improve_precent,label='fcapping',linewidth=2)


print(fcapping_improve_read_container)
print(fcapping_improve_precent)
#让图例生效
plt.legend()

#设置图表标题，并给坐标轴添加标签
plt.title("improve rewrite cost",fontsize=30)
plt.xlabel("Speed Factor",fontsize=20)
plt.ylabel("improve rewrite cost",fontsize=20)
