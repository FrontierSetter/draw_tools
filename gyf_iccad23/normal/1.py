...
valueArr = [66, 74, 79, 84, 91, 98, 103]
...
curP = plt.bar(range(len(xTick)), [x/valueArr[-1]*100 for x in valueArr], bar_width, color='#40A776')

# 设置坐标轴文字
plt.ylabel('DR of defective SSD (%)', fontsize=30)
