...
readbook = xlrd.open_workbook('COCO-RS(4,3)减少的网络传输时间-5-dataset-Alexnet.xlsx')
...
# plt.xticks(rotation=352) #x轴标签旋转
plt.subplots_adjust(left=0.14, right=0.98, top=0.99, bottom=0.04)#图片的页边距
...
plt.savefig('coco_transmission_time.pdf')
plt.show()